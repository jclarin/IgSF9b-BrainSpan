...
IgSF9b_expression$RPKM <- as.numeric(all_gene_expression[1528,]) #would be better if you could just type in the name of the gene of interest here
...
Brain_Avg <- unique(IgSF9b_expression [, c(2,3,10,13)]) #all unique rows from this subset of columns
...
Brain_Avg_Aov <- aov(TPM_Avg~ AgeCat, data = Brain_Avg)
summary(Brain_Avg_Aov) # p = 0.498
